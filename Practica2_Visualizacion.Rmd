...
grafico
grafico1 <- ggplot(ds, aes(x=MinTemp, y=Year)) + geom_violin(aes(colour=Year, fill=Year)) + labs(title = "Distribución de temperaturas máximas por año", x="Año", y="Temperatura(ºC)")
grafico1
...
grafico <- ggplot(chol, aes(x=HEIGHT))
grafico + geom_histogram() + labs(title="Histograma de la variable Altura", x="Altura(cm)", y="Frecuencia")
grafico1 <- grafico + geom_histogram(breaks=seq(155, 195, by=2))
grafico1
grafico2 <- grafico + geom_histogram(breaks=seq(155, 195, by=2),col="red",fill="blue",alpha=.5)
grafico2
grafico3 <- grafico2 + geom_histogram(aes(y=stat(density))) + geom_density(col="green")
grafico3
grafico4 <- grafico3 + facet_grid(.~SMOKE)
grafico4
